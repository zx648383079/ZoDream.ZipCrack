...
namespace ZoDream.Shared.Crack
{
    public class Attack
    {
        ...
        public IList<KeyItem> SolutionItems = new List<KeyItem>();
        ...
        public void TestXlist()
        {
            ...
            var keysForward = new KeyItem(XItems[7], YItems[7], ZItems[7]);
            ...
            // and also backward
            var keysBackward = new KeyItem(x, YItems[3], ZItems[3]);
            var p1 = Index + 2;
